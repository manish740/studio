    ...
    <section className="py-24 px-4 bg-white/50 backdrop-blur-sm">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Couple Photo Area */}
          <ScrollReveal delay={200} className="relative aspect-[4/5] md:aspect-square lg:aspect-auto lg:h-[600px] rounded-3xl overflow-hidden shadow-2xl border-8 border-white">
            {couplePhoto && (
              <Image
          ...
          <div className="space-y-12">
            <ScrollReveal delay={400} className="space-y-4">
              <div className="flex items-center gap-3 mb-2">
                <span className="text-accent font-headline text-4xl italic">M</span>
                <h3 className="text-3xl font-headline text-primary">Manish</h3>
              </div>
            ...
            <ScrollReveal delay={600} className="space-y-4">
              <div className="flex items-center gap-3 mb-2">
                <span className="text-accent font-headline text-4xl italic">S</span>
                <h3 className="text-3xl font-headline text-primary">Sakshi</h3>
              </div>
              <p className="text-lg text-muted-foreground leading-relaxed italic">
