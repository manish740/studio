  ...
  const events: WeddingEvent[] = [
    {
      ...
      location: "Aggarwal Dharamshala, Madhuban Rd, Dayanand Colony, Shakarpur, Delhi, 110092",
      description: "An evening of vibrant colors, music, and henna as we celebrate the union at Aggarwal Dharamshala.",
